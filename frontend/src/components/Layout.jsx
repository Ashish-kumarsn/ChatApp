    ...
    <div className={`min-h-screen ${theme === 'dark' ? "bg-[#111b21] text-white" : "bg-gray-100 text-black"} flex relative`}>
      ...
      {isThemeDialogOpen && (
        <div className='fixed inset-0 flex items-center justify-center bg-black/30 z-50'>
          <div className={`${theme === 'dark' ? "bg-[#202c22] text-white " : "bg-white text-black"} p-6 rounded-lg shadow-lg max-w-sm w-full `}>
            ...
            <button onClick={toggleThemeDialog} className='mt-6 w-full bg-blue text-white py-2 rounded bg-blue-600 transition duration-200'>
              Close
