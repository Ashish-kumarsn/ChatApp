      ...
      <div className='p-2'>
        <div className='relative' >
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 border rounded-lg focus:outline-none focus:ring-green-500 ${theme === "dark" ? "bg-gray-800 text-white border-gray-700 placeholder-gray-500" : "bg-gray-100 text-black border-gray-200 placeholder-gray-400"}`}
            value={searchTerms}
