              ...
              <div className="relative">
                <div className="flex">
                  <div className="relative w-1/3">
                    <button type="button"
                      className={`flex-shrink-0 z-10 inline-flex item-center py-2.5 px-4 text-sm font-medium text-center ${theme === 'dark' ? "text-white bg-gray-700 border-gray-600" : "text-gray-900 bg-gray-100 border-gray-300"} border rounded-s-lg hover:bg-gray-200 focus:right-4 focus:outline-none focus:ring-gray-100`}
                  ...
                  <input
                    ...
                    className={`w-2/3 px-4 py-2 border ${theme === 'dark' ? "bg-gray-700 text-white" : "bg-white border-gray-300"}rounded-md  focus:outline-none focus:right-2 focus:ring-green-500 ${loginErrors.phoneNumber ? "border-red-500" : ""}`}
                  />
        ...
        {step === 2 && (
          <form onSubmit={handleOtpSubmit(onOtpSubmit)} className="space-y-4">
            ...
            <button
              type="button"
              onClick={handleBack}
              className={`w-full mt-2 ${theme === 'dark' ? "bg-gray-700 text-gray-300" : "bg-gray-200 text-gray-700"}py-2 rounded-md hover:bg-gray-300 transitoon flex items-center justify-center`}
            >
          ...
          <form onSubmit={handleProfileSubmit(onProfileSubmit)} className="space-y-4">
            ...
            <div className="flex flex-col items-center mb-4">
              ...
              <div className="w-full">
                <p className={`text-sm text-center ${theme === 'dark' ? "text-gray-300" : "text-gray-500"} mb-2`}>
                  Choose an avatar
                </p>
            ...
            <button
              ...
              className={`w-full bg-green-500 text-white font-bold py-3 px-4 rounded-md hover:bg-green-600 transition duration-300 ease-in-out transform hover:scale-105 flex items-center text-lg
